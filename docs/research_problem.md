##Research Problem
Legacy oil and gas wells contain critical operational knowledge within unstructured documents such as Daily Drilling Reports, completion reports, and operational summaries.

These records describe how a well was actually constructed and operated, including drilling issues, losses, kicks, casing operations, cementing behaviour, and non-productive time. However, the information exists primarily as human-readable documents and cannot be queried across wells.
